...
-- ============================================================
-- WATERMARK ONLY (no dark background)
-- ============================================================
task.spawn(function()
    ...
    wGui.Parent = LocalPlayer:WaitForChild("PlayerGui")

    local wm = Instance.new("TextLabel", wGui)
...
tabMain:AddToggle("tg_AutoCash", {
    Title       = "Auto Cash",
    Description = "Loops Buy, Spawn and Sell jeepney to farm cash",
    Default = false,
    Callback = function(v)
        getgenv().Autocash = v
        if v then
...
tabMain:AddToggle("tg_AutoCoins", {
    Title       = "Auto Coins",
    Description = "Auto farm coins from passengers",
    Default = false,
    Callback = function(v)
        getgenv().AutoCoins = v
        if v then
...
tabMain:AddToggle("tg_AutoSukli", {
    Title       = "Auto Sukli",
    Description = "Automatically computes and gives change to passengers",
    Default = false,
    Callback = function(v)
        getgenv().AutoSukli = v
...
tabMain:AddDropdown("dd_DupAmt", {
    ...
    Description = "Select how much cash to duplicate",
...
tabMain:AddToggle("tg_DupeCashGUI", {
    ...
    Description = "Spawns draggable ON/OFF GUI for cash dupe",
    Default = false,
...
tabMain:AddToggle("tg_DupeCoin", {
    ...
    Description = "Auto farm coins non-stop",
    Default = false,
...
tabExp:AddToggle("tg_ExpRep", {
    ...
    Description = "Gain EXP & Reputation fast",
    Default = false,
    Callback = function(state)
...
tabExp:AddToggle("tg_MassiveExp", {
    ...
    Description = "Tuloy-tuloy na EXP at massive passengers",
    Default = false,
    Callback = function(state)
...
tabExp:AddButton({ Title = "Malolos Load",   Description = "Load point", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.TerminalParts["Malolos - Bulakan"].ToMalolosTerminalLoadPoint) end })
tabExp:AddButton({ Title = "Bulakan Load",   Description = "Load point", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.TerminalParts["Malolos - Bulakan"].ToBulakanTerminalLoadPoint) end })
tabExp:AddButton({ Title = "Guiguinto Load", Description = "Load point", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.TerminalParts["Guiguinto - Bulakan"].ToGuiguintoTerminalLoadPoint) end })
tabExp:AddButton({ Title = "Balagtas Load",  Description = "Load point", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.TerminalParts["Balagtas - Bulakan"].ToBalagtasTerminalLoadPoint) end })
tabExp:AddButton({ Title = "Malolos Drop",   Description = "Drop point", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.PassengerSpawnPoints["Malolos - Bulakan"].MalolosTerminalDropPoint) end })
tabExp:AddButton({ Title = "Bulakan Drop",   Description = "Drop point", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.PassengerSpawnPoints["Malolos - Bulakan"].BulakanTerminalDropPoint) end })
tabExp:AddButton({ Title = "Guiguinto Drop", Description = "Drop point", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.PassengerSpawnPoints["Guiguinto - Bulakan"].GuiguintoTerminalDropPoint) end })
tabExp:AddButton({ Title = "Balagtas Drop",  Description = "Drop point", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.PassengerSpawnPoints["Balagtas - Bulakan"].BalagtasTerminalDropPoint) end })
...
tabTroll:AddToggle("tg_Flinger", {
    ...
    Description = "Fling the selected target player",
    Default = false,
    Callback = function(v)
        flingEnabled = v
        local hrp = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
...
tabTroll:AddToggle("tg_FlingAll", {
    Title       = "Fling All",
    Description = "Randomly fling all players",
    Default = false,
    Callback = function(v)
        flingAll = v
        local hrp = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
...
tabTroll:AddToggle("tg_EngineTroll", {
    Title       = "Engine Troll",
    Description = "Max out engine volume and pitch",
    Default = false,
    Callback = function(state)
...
tabOther:AddToggle("tg_AutoKM", {
    ...
    Description = "Auto fly between two points to farm kilometers",
    Default = false,
    Callback = function(v)
        isKmActive = v
        if v then
