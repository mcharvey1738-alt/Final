...
task.spawn(function()
    ...
    grad.Color = ColorSequence.new({
        ...
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(25, 5,  70)),
        ColorSequenceKeypoint.new(1,   Color3.fromRGB(40, 8,  90)),
    })
    grad.Rotation = 135

    -- Animated purple floating orbs/stars
    for i = 1, 22 do
        ...
        star.BackgroundTransparency = math.random(20, 55) / 100
        star.ZIndex = -4
        ...
        task.spawn(function()
            while true do
                ...
                local t = TweenService:Create(star,
                    ...
                    { Position = endPos, BackgroundTransparency = math.random(30, 70)/100 }
                )
    ...
    -- Soft purple overlay vignette
    local vignette = Instance.new("ImageLabel", frame)
    vignette.Size = UDim2.fromScale(1, 1)
    vignette.BackgroundTransparency = 1
    vignette.Image = "rbxassetid://5905752897"
    vignette.ImageColor3 = Color3.fromRGB(80, 20, 140)
