...
-- ============================================================
-- PURPLE ANIME BACKGROUND + WATERMARK
-- ============================================================
task.spawn(function()
    ...
    -- Transparent frame — no solid bg, game still visible
    local frame = Instance.new("Frame", bg)
    frame.Size = UDim2.fromScale(1, 1)
    frame.BackgroundTransparency = 1
    frame.ZIndex = -5

    -- Animated purple floating orbs
    for i = 1, 22 do
        local orb = Instance.new("Frame", frame)
        local sz = math.random(6, 14)
        orb.Size = UDim2.fromOffset(sz, sz)
        orb.Position = UDim2.fromScale(math.random(0, 100)/100, math.random(0, 100)/100)
        orb.BackgroundColor3 = Color3.fromRGB(
            math.random(120, 180),
            math.random(60, 100),
            math.random(220, 255)
        )
        orb.BackgroundTransparency = math.random(20, 50) / 100
        orb.ZIndex = -4
        Instance.new("UICorner", orb).CornerRadius = UDim.new(1, 0)

        local glow = Instance.new("UIStroke", orb)
        ...
        task.spawn(function()
            while true do
                ...
                local t = TweenService:Create(orb,
                    TweenInfo.new(math.random(6, 16), Enum.EasingStyle.Sine, Enum.EasingDirection.InOut),
                    { Position = endPos, BackgroundTransparency = math.random(30, 65)/100 }
                )
    ...
    wm.TextColor3 = Color3.fromRGB(200, 160, 255)
    wm.TextTransparency = 0.3
...
-- CUSTOM PURPLE THEME
-- ============================================================
Fluent:RegisterCustomTheme("BellePurple", {
    Accent              = Color3.fromRGB(139, 92, 246),
    AcrylicMain         = Color3.fromRGB(20, 8, 45),
    AcrylicBorder       = Color3.fromRGB(100, 50, 180),
    AcrylicGradient     = ColorSequence.new({
        ColorSequenceKeypoint.new(0,   Color3.fromRGB(35, 12, 75)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(20,  7, 50)),
        ColorSequenceKeypoint.new(1,   Color3.fromRGB(28, 10, 65)),
    }),
    AcrylicNoise        = 0.4,
    TitleBarLine        = Color3.fromRGB(120, 60, 210),
    Tab                 = Color3.fromRGB(30, 12, 60),
    Element             = Color3.fromRGB(26, 10, 52),
    ElementBorder       = Color3.fromRGB(100, 50, 170),
    InElementBorder     = Color3.fromRGB(139, 92, 246),
    ElementTransparency = 0.72,
    ToggleSlider        = Color3.fromRGB(45, 20, 80),
    ToggleToggled       = Color3.fromRGB(139, 92, 246),
    SliderRail          = Color3.fromRGB(45, 20, 80),
    DropdownFrame       = Color3.fromRGB(22, 9, 46),
    DropdownHolder      = Color3.fromRGB(15, 6, 32),
    DropdownBorder      = Color3.fromRGB(100, 50, 170),
    DropdownOption      = Color3.fromRGB(30, 12, 58),
    Keybind             = Color3.fromRGB(30, 12, 58),
    Input               = Color3.fromRGB(18, 7, 38),
    InputFocused        = Color3.fromRGB(12, 5, 26),
    InputIndicator      = Color3.fromRGB(139, 92, 246),
    Dialog              = Color3.fromRGB(14, 6, 30),
    DialogHolder        = Color3.fromRGB(10, 4, 22),
    DialogHolderLine    = Color3.fromRGB(100, 50, 170),
    DialogButton        = Color3.fromRGB(24, 10, 50),
    DialogButtonBorder  = Color3.fromRGB(100, 50, 170),
    DialogBorder        = Color3.fromRGB(100, 50, 170),
    DialogInput         = Color3.fromRGB(18, 7, 38),
    DialogInputLine     = Color3.fromRGB(139, 92, 246),
    Text                = Color3.fromRGB(245, 230, 255),
    SubText             = Color3.fromRGB(185, 145, 235),
    Hover               = Color3.fromRGB(55, 24, 100),
    HoverChange         = 0.05,
    ShineEnabled        = true,
    StrokeShine         = true,
    StrokeDark          = Color3.fromRGB(70, 35, 130),
    Shine = {
        Speed         = 0.5,
        RotationSpeed = 18,
    ...
    ButtonGradient = {
        Background = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(55, 24, 100)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(22,  8, 48)),
        }),
...
-- ============================================================
-- TELEPORT HELPER (shared by EXP & Teleport tabs)
-- ============================================================
local function tpJeepOrPlayer(target)
    ...
    local newPos = target.Position + Vector3.new(0, 5, 0)
...
tabExp:AddButton({ Title = "Malolos Load",   Callback = function() tpJeepOrPlayer(workspace.Map.Misc.TerminalParts["Malolos - Bulakan"].ToMalolosTerminalLoadPoint) end })
tabExp:AddButton({ Title = "Bulakan Load",   Callback = function() tpJeepOrPlayer(workspace.Map.Misc.TerminalParts["Malolos - Bulakan"].ToBulakanTerminalLoadPoint) end })
tabExp:AddButton({ Title = "Guiguinto Load", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.TerminalParts["Guiguinto - Bulakan"].ToGuiguintoTerminalLoadPoint) end })
tabExp:AddButton({ Title = "Balagtas Load",  Callback = function() tpJeepOrPlayer(workspace.Map.Misc.TerminalParts["Balagtas - Bulakan"].ToBalagtasTerminalLoadPoint) end })
tabExp:AddButton({ Title = "Malolos Drop",   Callback = function() tpJeepOrPlayer(workspace.Map.Misc.PassengerSpawnPoints["Malolos - Bulakan"].MalolosTerminalDropPoint) end })
tabExp:AddButton({ Title = "Bulakan Drop",   Callback = function() tpJeepOrPlayer(workspace.Map.Misc.PassengerSpawnPoints["Malolos - Bulakan"].BulakanTerminalDropPoint) end })
tabExp:AddButton({ Title = "Guiguinto Drop", Callback = function() tpJeepOrPlayer(workspace.Map.Misc.PassengerSpawnPoints["Guiguinto - Bulakan"].GuiguintoTerminalDropPoint) end })
tabExp:AddButton({ Title = "Balagtas Drop",  Callback = function() tpJeepOrPlayer(workspace.Map.Misc.PassengerSpawnPoints["Balagtas - Bulakan"].BalagtasTerminalDropPoint) end })
